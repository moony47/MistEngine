...
#include "Mist/Core/EntryPoint.h"
...
public:
    ExampleLayer() :
        ...
        MIST_TEXTURE2DLIB->Bind("Diamond", 0);
        MIST_SHADER("BasicTexture")->SetUniformTexture2D("u_Texture", MIST_TEXTURE2D("Diamond"));
...
public:
    Sandbox() :
        ...
        static_cast<TestMenu*>(m_TestMenu)->RegisterTest<TestClearColour>("TestClearColour");
        static_cast<TestMenu*>(m_TestMenu)->RegisterTest<TestSprites>("TestSprites");
        static_cast<TestMenu*>(m_TestMenu)->RegisterTest<TestSpritesBatch>("TestSpritesBatch");
