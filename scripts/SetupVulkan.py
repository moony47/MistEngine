...
class VulkanConfiguration:
    requiredVulkanVersion = "1.4.328.1"
    vulkanDirectory = "./Mist/vendor/VulkanSDK"
    ...
    def __InstallVulkanSDK(cls):
        ...
        vulkanPath = f"{cls.vulkanDirectory}/vulkansdk-windows-{cls.requiredVulkanVersion}.exe"
        vulkanInstallURL = f"https://sdk.lunarg.com/sdk/download/latest/windows/vulkan_sdk.exe"
        if not os.path.exists(vulkanPath):
