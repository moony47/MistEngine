...
namespace Mist {
	...
	OpenGLShader::OpenGLShader(const std::string& vertShaderPath,
	...
	std::expected<unsigned int, std::string> OpenGLShader::CompileShader(unsigned int type, const std::string& source) const {
