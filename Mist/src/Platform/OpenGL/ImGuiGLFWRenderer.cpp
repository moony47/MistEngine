...
ImGuiKey KeyCodeMistToImGui(int keycode, int scancode) {
    IM_UNUSED(scancode);
    switch (keycode)
    {
        case MIST_KEY_TAB: return ImGuiKey_Tab;
        case MIST_KEY_LEFT:
        ...
        case MIST_KEY_PAGE_UP:
            return ImGuiKey_PageUp;
        case MIST_KEY_PAGE_DOWN:
            return ImGuiKey_PageDown;
        case MIST_KEY_HOME:
            return ImGuiKey_Home;
        case MIST_KEY_END:
            return ImGuiKey_End;
        case MIST_KEY_INSERT:
            return ImGuiKey_Insert;
        case MIST_KEY_DELETE:
            return ImGuiKey_Delete;
        case MIST_KEY_BACKSPACE:
            return ImGuiKey_Backspace;
        case MIST_KEY_SPACE:
            return ImGuiKey_Space;
        case MIST_KEY_ENTER:
            return ImGuiKey_Enter;
        case MIST_KEY_ESCAPE:
            return ImGuiKey_Escape;
        case MIST_KEY_APOSTROPHE:
            return ImGuiKey_Apostrophe;
        case MIST_KEY_COMMA:
            return ImGuiKey_Comma;
        case MIST_KEY_MINUS:
            return ImGuiKey_Minus;
        case MIST_KEY_PERIOD:
            return ImGuiKey_Period;
        case MIST_KEY_SLASH:
            return ImGuiKey_Slash;
        case MIST_KEY_SEMICOLON:
            return ImGuiKey_Semicolon;
        case MIST_KEY_EQUAL:
            return ImGuiKey_Equal;
        case MIST_KEY_LEFT_BRACKET:
            return ImGuiKey_LeftBracket;
        case MIST_KEY_BACKSLASH:
            return ImGuiKey_Backslash;
        case MIST_KEY_WORLD_1:
            return ImGuiKey_Oem102;
        case MIST_KEY_WORLD_2:
            return ImGuiKey_Oem102;
        case MIST_KEY_RIGHT_BRACKET:
            return ImGuiKey_RightBracket;
        case MIST_KEY_GRAVE_ACCENT:
            return ImGuiKey_GraveAccent;
        case MIST_KEY_CAPS_LOCK:
            return ImGuiKey_CapsLock;
        case MIST_KEY_SCROLL_LOCK:
            return ImGuiKey_ScrollLock;
        case MIST_KEY_NUM_LOCK:
            return ImGuiKey_NumLock;
        case MIST_KEY_PRINT_SCREEN:
        ...
        case MIST_KEY_KP_DECIMAL:
            return ImGuiKey_KeypadDecimal;
        case MIST_KEY_KP_DIVIDE:
            return ImGuiKey_KeypadDivide;
        case MIST_KEY_KP_MULTIPLY:
            return ImGuiKey_KeypadMultiply;
        case MIST_KEY_KP_SUBTRACT:
            return ImGuiKey_KeypadSubtract;
        case MIST_KEY_KP_ADD:
            return ImGuiKey_KeypadAdd;
        case MIST_KEY_KP_ENTER:
            return ImGuiKey_KeypadEnter;
        case MIST_KEY_KP_EQUAL:
            return ImGuiKey_KeypadEqual;
        case MIST_KEY_LEFT_SHIFT:
            return ImGuiKey_LeftShift;
        case MIST_KEY_LEFT_CONTROL:
            return ImGuiKey_LeftCtrl;
        case MIST_KEY_LEFT_ALT:
            return ImGuiKey_LeftAlt;
        case MIST_KEY_LEFT_SUPER:
            return ImGuiKey_LeftSuper;
        case MIST_KEY_RIGHT_SHIFT:
            return ImGuiKey_RightShift;
        case MIST_KEY_RIGHT_CONTROL:
            return ImGuiKey_RightCtrl;
        case MIST_KEY_RIGHT_ALT:
            return ImGuiKey_RightAlt;
        case MIST_KEY_RIGHT_SUPER:
...
// FIXME: should this be baked into KeyCodeMistToImGui()? then what about the values passed to io.SetKeyEventNativeData()?
...
void ImGui_ImplGlfw_KeyCallback(GLFWwindow* window, int keycode, int scancode, int action, int mods)
{
    ...
    ImGuiKey imgui_key = KeyCodeMistToImGui(keycode, scancode);
